...
query = (
    ...
    .format("delta")
    .outputMode("append")
    .option("path", "hdfs://localhost:9000/user/jayesh/project/orders/orders_bronze/")
    .option("checkpointLocation", "hdfs://localhost:9000/user/jayesh/project/checkpoints/orders_bronze/")
