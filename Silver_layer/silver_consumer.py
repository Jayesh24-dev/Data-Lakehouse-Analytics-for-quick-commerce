...
bronze_df = (
    spark.readStream
    .format("delta")
    .load("hdfs://localhost:9000/user/jayesh/project/orders/orders_bronze/")
)
...
query = (
    ...
    .option(
        "checkpointLocation",
        "hdfs://localhost:9000/user/jayesh/project/checkpoints/orders_silver/"
    )
    .trigger(processingTime="2 seconds")
    .start(
        "hdfs://localhost:9000/user/jayesh/project/orders/orders_silver/"
    )
)
